...
if __name__ == "__main__":
    ...
    parser.add_argument('--sampling_modifiedRS_rho_search_space', nargs="*", type=float, help="The target imbalance rate rho for a random over/undersampler (>=1).", default=[1.0, 2.0, 3, 5])
    parser.add_argument('--augmentation_rho_search_space', nargs="*", type=float, help="The target imbalance rate rho for augmentation (>=1).", default=[1.0, 2.0, 3, 5])
